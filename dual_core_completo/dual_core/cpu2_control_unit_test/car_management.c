...
void read_map_sw_message(Uint16 val[])
{
    ...
    Torque_Vectoring_2024_2_P.T_max = car_settings.max_pos_torque;
    Torque_Vectoring_2024_2_P.Pmax = car_settings.power_limit;
...
void updateTVstruct() {
   ...
   Torque_Vectoring_2024_2_U.ax = accelerations[0];
   Torque_Vectoring_2024_2_U.ay = accelerations[1];
   Torque_Vectoring_2024_2_U.yaw_r = omegas[2];
   Torque_Vectoring_2024_2_U.throttle = throttle/100.0f;
   Torque_Vectoring_2024_2_U.brakepressurefront = brakePress1;
   Torque_Vectoring_2024_2_U.brakepressurerear = brakePress2;
   Torque_Vectoring_2024_2_U.regenpaddle = paddle/100.0f;
   Torque_Vectoring_2024_2_U.steering = steering;
   Torque_Vectoring_2024_2_U.rpm[0] = motorVal1[0].AMK_ActualVelocity;
   Torque_Vectoring_2024_2_U.rpm[1] = motorVal1[1].AMK_ActualVelocity; // rpm
   Torque_Vectoring_2024_2_U.rpm[2] = motorVal1[2].AMK_ActualVelocity; // rpm
   Torque_Vectoring_2024_2_U.rpm[3] = motorVal1[3].AMK_ActualVelocity; // rpm
   Torque_Vectoring_2024_2_U.voltage = batteryPackTension;
