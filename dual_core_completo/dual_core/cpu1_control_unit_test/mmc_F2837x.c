...
static void SELECT(void) // EDITED
{
    //
    // Select the SD card.
    //
...
static void DESELECT(void) // EDITED
{
...
static BYTE rcvr_spi(void) // EDITED
{
...
/*-----------------------------------------------------------------------*/
static void send_initial_clock_train(void) // EDITED
{
    volatile DWORD dat;
...
static void power_on(void) // EDITED
{
    /*
...
static void set_max_speed(void) // EDIT
{
    /* Disable the SPI*/
